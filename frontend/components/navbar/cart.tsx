...
import {Dropdown, DropdownItem, DropdownMenu, DropdownTrigger, Image, NavbarItem,} from "@nextui-org/react";
                    ...
                    <div className="flex items-center gap-x-4 border-divider py-4">
                        ...
                        <div className="flex flex-1 flex-col">
                            ...
                            <div className="flex items-center gap-3"><p><span
                                ...
                                className="text-small font-medium capitalize text-default-700">black</span></p><p><span
